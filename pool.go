...
// NewPoolCustom is like New except you can specify a DialFunc which will be used when creating new connections for the pool.
// The common use-case is to do authentication for new connections.
...
// NewPool creates a new NatsPool whose connections are all created using nats.Connect.
// The size indicates the maximum number of idle connections to have waiting to be used at any given moment.
// If an error is encountered an empty (but still usable) pool is returned alongside that error
